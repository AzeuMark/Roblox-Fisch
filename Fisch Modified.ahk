...
; Amount of clicks per action cycle | Def = 10
StabilizerLoop := 10
...
tooltip, Modified by Azeu_Mark. (cred. AsphaltCake), %TooltipX%, %Tooltip1%, 1
tooltip, Runtime: 0h 0m 0s, %TooltipX%, %Tooltip2%, 2

tooltip, Press (➤) arrow to Start, %TooltipX%, %Tooltip4%, 4
tooltip, Press (⬅) arrow to Reload, %TooltipX%, %Tooltip5%, 5
tooltip, Press (⬇) arrow to Exit, %TooltipX%, %Tooltip6%, 6
...
tooltip, Press (⬅) arrow to Reload, %TooltipX%, %Tooltip4%, 4
tooltip, Press (⬇) arrow to Exit, %TooltipX%, %Tooltip5%, 5
